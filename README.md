...
<div align="center">
    <video src='./video/yolo_traffic_1.mp4' width=800 autoplay loop title='actual model output from this model!'> </video><br>Raw YOLO output with NMS!<br>Yellow for Bus, Red for Vehicle
</div>
